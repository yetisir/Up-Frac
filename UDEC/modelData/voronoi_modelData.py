...
ostrichParameters = {'frictionAngle':{'init':15, 'low':5, 'high':30}, 
                                'dilationAngle':{'init':10, 'low':5, 'high':15},
                                'hardening_A':{'init':2e6, 'low':1e6, 'high':5e6},
                                'hardening_B':{'init':4e6, 'low':1e6, 'high':10e6},
                                'hardening_n':{'init':0.5, 'low':0.1, 'high':0.9},
                                'johnson_D2':{'init':1e-3, 'low':0.1e-3, 'high':10e-3},
                                'johnson_D3':{'init':-2, 'low':-5, 'high':-1},
                                'failureDisplacement':{'init':2.5e-3, 'low':1e-3, 'high':5e-3},
                                'initialTensileStrength':{'init':3e6, 'low':1e6, 'high':10e6},
                                'elasticModulus':{'init':7.5e9, 'low':5e9, 'high':15e9},
                                'poissonsRatio':{'init':0.35, 'low':0.3, 'high':0.4}}
